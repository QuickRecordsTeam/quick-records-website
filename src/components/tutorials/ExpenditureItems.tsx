      ...
      >
        <div className="container section-title" data-aos="fade-up">
          ...
          <p>
            ...
            reporting by linking every expense to a specific payment item (activity).

           Expenditure Items are grouped under Expenditure Categories to keep different transaction types organized. It provides a clear overview of how funds are being utilized across various organizational projects.
          </p>
        </div>
        ...
        <section id="portfolio" className="portfolio section">
          <div className="container" data-aos="fade-up" data-aos-delay="100">
            ...
            >
              ...
              >
                <div className="col-lg-6 col-md-6 portfolio-item isotope-item filter-web">
                  <h3>Step 3: Add Expenditure Item</h3>
              ...
              >
                <div className="col-lg-6 col-md-6 portfolio-item isotope-item filter-web">
                  <h3>Step 4: Fill Expenditure Item Information</h3>
