...
export const ExpenditureItemDetails = () => {
  return (
    <Fragment>
      <section
        id="features"
      ...
      >
        <div className="container section-title" data-aos="fade-up">
          <h2>Expenditure Items Details</h2>
          <p>
            An Expenditure Item Detail allows you to record the specific
            breakdown of costs—such as "Purchase of Materials (5000 XAF)" or
            "Labor Cost (10000 XAF)"—within a broader Expenditure Item. Tracks
            every cent spent on individual tasks. <br />
            Compares budgeted amounts against actual expenditures. <br />
            Provides a clear audit trail for where the organization’s money is
            going.
          </p>
        </div>
        ...
        <section id="portfolio" className="portfolio section">
          <div className="container" data-aos="fade-up" data-aos-delay="100">
            ...
            >
              ...
              >
                <div className="col-lg-6 col-md-6 portfolio-item isotope-item filter-web">
                  <h3>Step 4: View Expenditure Detials</h3>
                  <ul>
                    <li>
                      <span>
                        Click on the menu icon, then click <b>Details</b>options
                        to view details of the expenditure item.
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              >
                <div className="col-lg-6 col-md-6 portfolio-item isotope-item filter-web">
                  <h3>Step 5: Add Expenditure Item Item</h3>

                  <ul>
                    <li>
                      <span>
                        Click the <b>Add +</b> button an expenditure item detail
                        under a specific expenditure item..
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              >
                <div className="col-lg-6 col-md-6 portfolio-item isotope-item filter-web">
                  <h3>Step 6: Fill Expenditure Item Information</h3>
                  ...
                  <ul>
                    ...
                    <li>
                      <span>
                        ...
                        adding a new expenditure item detail.
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="col-lg-6 col-md-6 portfolio-item isotope-item filter-graphics">
                  <div className="portfolio-card">
                    <div className="">
                      <img
                        src="/img/expenditure/add_exp_detail_form.png"
                        className="img-fluid"
                        alt=""
                        loading="lazy"
                      ></img>
              ...
              >
                  ...
                  <ul>
                    <li>
                      <span>
                        ...
                        button to validate an expenditure item detail.
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="col-lg-6 col-md-6 portfolio-item isotope-item filter-graphics">
                  <div className="portfolio-card">
                    <div className="">
                      <img
                        src="/img/expenditure/validate_expenditure.png"
                        className="img-fluid"
                        alt=""
                        loading="lazy"
                      ></img>
              ...
              >
                <div className="col-lg-6 col-md-6 portfolio-item isotope-item filter-web">
                  <h3>Step 6.1: Approve the Expenditure Item detail</h3>
                  <ul>
                    <li>
                      <span>
                        Click on the <b>Approve</b> button to approve the
                        record.
                      </span>
                    </li>
                  </ul>
                ...
                <div className="col-lg-6 col-md-6 portfolio-item isotope-item filter-graphics">
                  <div className="portfolio-card">
                    <div className="">
                      <img
                        src="/img/expenditure/approve_detail.png"
                        className="img-fluid"
                        alt=""
                        loading="lazy"
                      ></img>
              ...
              >
                <div className="col-lg-6 col-md-6 portfolio-item isotope-item filter-web">
                  <h3>Step 6.2: Decline the Registration</h3>
                  <ul>
                    <li>
                      <span>
                        Click on the <b>Decline</b> button to reject the record
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="col-lg-6 col-md-6 portfolio-item isotope-item filter-graphics">
                  <div className="portfolio-card">
                    <div className="">
                      <img
                        src="/img/expenditure/decline_detail.png"
                        className="img-fluid"
                        alt=""
                        loading="lazy"
                      ></img>
              ...
              >
                <div className="col-lg-6 col-md-6 portfolio-item isotope-item filter-web">
                  <h3>Step 7: Update Expenditure Item Detail (optional)</h3>
                  <p className="fst-italic">
                    Tip1: Once a record has been validated it <b>Can not</b> be
                    edited again
                  </p>
                  <ul>
                    <li>
                      <span>
                        Click the menu icon to <b>View</b>, <b>Edit</b> or{" "}
                        <b>Delete</b> the record
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="col-lg-6 col-md-6 portfolio-item isotope-item filter-graphics">
                  <div className="portfolio-card">
                    <div className="">
                      <img
                        src="/img/expenditure/update_detail.png"
                        className="img-fluid"
                        alt=""
                        loading="lazy"
                      ></img>
